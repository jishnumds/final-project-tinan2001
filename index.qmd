...
kable(og_bbox, col.names = ("Bounding Box Coordinates"), align = "c", caption = "Original Bounding Box")
```
...
kable(new_bbox, col.names = c("X Coord","Y Coord"), align = "cc", caption = "New Bounding Poly Coordinates")
```
