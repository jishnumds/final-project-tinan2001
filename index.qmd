...
author: "Tina Ni"
subtitle: "Utilizing Lidar Point Cloud Data to Map Out Forest Tree Top Clustering"
date: today
date-format: long
---
...
rglwidget(x = scene3d(filterOUT_las))
```

##Check If New Data Will Correctly Transform to Leaflet Projection
###The original data uses NAD 83 (2011) and Leaflet uses WGS 84
...
unique(las_df$long)
```
##Rasterize LiDAR Data to Identify Tree Tops, Identify the Tree Population, Create a Data Set of the 90th Percentile of Trees Based On Height (Tallest Trees).
...
```
## Location of the Tallest Trees,and Tree Tops within the Forest
```{r echo = FALSE}
...
plot(tall_trees)
plot(tall_trees[3], pch = 16, cex = .5, col = factor(tall_trees$dbscan_cluster))
