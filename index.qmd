...
kable(allT[1:10,], col_names = c("Tree ID", "Height (m)", "Location"), align = ("ccc"), caption = "First 10 Tree Heights (m)")

ninT <- as.data.frame(tall_trees)
ninT$Z <- tall_trees$Z - 190
ninT$Z <- formatC(ninT$Z)
kable(ninT[1:10,1:3], col_names = c("Tree ID", "Height (m)", "Location"), align = ("ccc"), caption = "First 10 90th Percentile Tree Heights (m)")
```
